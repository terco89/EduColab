<nav class="navbar navbar-expand-lg navbar-dark navbar-educolab">
    <a class="navbar-brand" href="index.php"><img src="img/EduCollab_simple.png" width="50">EduCollab</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <?php } else if (!isset($_SSESIOB['usuario'])) { ?>
            <a href="login.php" style="color:white"><button class="btn btn-light my-2 my-sm-0 mr-2" type="button">Iniciar sesión</button></a>
